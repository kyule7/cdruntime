...
//  CDHandle* cd1 = CDPath::GetCurrentCD()->Create("CD1", kStrict, 0, 0, &err);
...
//      CDHandle* cd2 = CDPath::GetCurrentCD()->Create(CDPath::GetCurrentCD()->GetNodeID(), 1, "CD2", kStrict, 0, 0, &err);
      CDHandle* cd2 = CDPath::GetCurrentCD()->Create("CD2", kStrict, 0, 0, &err);
      cout << "CD 2 created \n"<<endl;
