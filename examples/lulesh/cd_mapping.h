...
#define CD_MAP_0_0_0   ((1<<CDFLAG_SIZE) | kStrict | kDRAM) // 
#define SWITCH_1_1_0   0                                  // TimeIncrement
#define CD_MAP_1_1_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM) //
#define SWITCH_1_2_0   0                                  // LagrangeLeapFrog
#define CD_MAP_1_2_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM) //
#define SWITCH_2_0_0   2                                  //       LagrangeNodal
#define CD_MAP_2_0_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM) //   
#define SWITCH_3_0_0   0                                  //           CalcForceForNodes (commRecv before)
#define CD_MAP_3_0_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //       
#define SWITCH_4_0_0   0                                  //               CalcVolumeForceForElems (comm before/after)
#define CD_MAP_4_0_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                 //   
#define SWITCH_5_0_0   0                                  //                   InitStressTermsForElems
#define CD_MAP_5_0_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //          
#define SWITCH_5_1_0   0                                  //                   IntegrateStressForElems
#define CD_MAP_5_1_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //       
#define SWITCH_5_1_1   0                                  //                       Loop_IntegrateStressForElems
#define CD_MAP_5_1_1   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //             
#define SWITCH_6_0_0   0                                  //                       CollectDomainNodesToElemNodes (inside loop)
#define CD_MAP_6_0_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //                
#define SWITCH_6_1_0   0                                  //                       CalcElemShapeFunctionDerivatives (inside loop)
#define CD_MAP_6_1_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //              
#define SWITCH_6_2_0   0                                  //                       CalcElemNodeNormals (inside loop)
#define CD_MAP_6_2_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //             
#define SWITCH_6_3_0   0                                  //                       SumElemStressesToNodeForces (inside loop)
#define CD_MAP_6_3_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //            
#define SWITCH_5_2_0   0                                  //                   CalcHourglassControlForElems
#define CD_MAP_5_2_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //           
#define SWITCH_6_4_0   0                                  //                       Loop_CalcHourglassControlForElems
#define CD_MAP_6_4_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //             
#define SWITCH_6_5_0   0                                  //                       CollectDomainNodesToElemNodes
#define CD_MAP_6_5_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //             
#define SWITCH_6_6_0   0                                  //                       CalcElemVolumeDerivative
#define CD_MAP_6_6_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //            
#define SWITCH_6_7_0   0                                  //                       CalcFBHourglassForceForElems
#define CD_MAP_6_7_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //               
#define SWITCH_7_0_0   0                                  //                           Loop_CalcFBHourglassForceForElems
#define CD_MAP_7_0_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //              
#define SWITCH_7_1_0   0                                  //                           CalcElemFBHourglassForce
#define CD_MAP_7_1_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //                 
#define SWITCH_3_1_0   0                                  //           CalcAccelerationForNodes
#define CD_MAP_3_1_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //     
#define SWITCH_3_2_0   0                                  //           ApplyAccelerationBoundaryConditionsForNodes
#define CD_MAP_3_2_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //    
#define SWITCH_3_3_0   0                                  //           CalcVelocityForNodes
#define CD_MAP_3_3_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //      
#define SWITCH_3_4_0   0                                  //           CalcPositionForNodes
#define CD_MAP_3_4_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //     
#define SWITCH_2_1_0   2                                  //       LagrangeElements
#define CD_MAP_2_1_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //   
#define SWITCH_3_5_0   0                                  //           CalcLagrangeElements
#define CD_MAP_3_5_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //    
#define SWITCH_4_1_0   0                                  //               CalcKinematicsForElems
#define CD_MAP_4_1_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //      
#define SWITCH_5_4_0   0                                  //                   CollectDomainNodesToElemNodes
#define CD_MAP_5_4_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //       
#define SWITCH_5_5_0   0                                  //                   CalcElemVolume
#define CD_MAP_5_5_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //          
#define SWITCH_5_6_0   0                                  //                   CalcElemCharacteristicLength
#define CD_MAP_5_6_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //              
#define SWITCH_5_7_0   0                                  //                   InnerLoopInCalcKinematicsForElems
#define CD_MAP_5_7_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //            
#define SWITCH_5_8_0   0                                  //                   CalcElemShapeFunctionDerivatives
#define CD_MAP_5_8_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //         
#define SWITCH_5_9_0   0                                  //                   CalcElemVelocityGradient
#define CD_MAP_5_9_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //             
#define SWITCH_4_2_0   0                                  //               LoopInCalcLagrangeElements
#define CD_MAP_4_2_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //          
#define SWITCH_3_6_0   0                                  //           CalcQForElems (Comm in it)
#define CD_MAP_3_6_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //      
#define SWITCH_4_3_0   0                                  //               CalcMonotonicQGradientsForElems
#define CD_MAP_4_3_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //              
#define SWITCH_4_4_0   0                                  //               CalcMonotonicQForElems (loop in it)
#define CD_MAP_4_4_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //          
#define SWITCH_5_10_0  0                                  //                   CalcMonotonicQRegionForElems (loop in it)
#define CD_MAP_5_10_0  ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //           
#define SWITCH_3_7_0   0                                  //           ApplyMaterialPropertiesForElems
#define CD_MAP_3_7_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //       
#define SWITCH_4_5_0   0                                  //               EvalEOSForElems FIXME
#define CD_MAP_4_5_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //            
#define SWITCH_5_11_0  0                                  //                   CalcEnergyForElems (loop)
#define CD_MAP_5_11_0  ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //        
#define SWITCH_6_8_0   0                                  //                       CalcPressureForElems1
#define CD_MAP_6_8_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //           
#define SWITCH_6_9_0   0                                  //                       CalcPressureForElems2
#define CD_MAP_6_9_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //               
#define SWITCH_6_10_0  0                                  //                       CalcPressureForElems3
#define CD_MAP_6_10_0  ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //              
#define SWITCH_5_12_0  0                                  //                   CalcSoundSpeedForElems
#define CD_MAP_5_12_0  ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //             
#define SWITCH_3_8_0   0                                  //           UpdateVolumesForElems
#define CD_MAP_3_8_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //      
#define SWITCH_2_2_0   2                                  //       CalcTimeConstraintsForElems
#define CD_MAP_2_2_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  //     
#define SWITCH_3_9_0   0                                  //           CalcCourantConstraintForElems
#define CD_MAP_3_9_0   ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  // 
#define SWITCH_3_10_0  0                                  //           CalcHydroConstraintForElems
#define CD_MAP_3_10_0  ((8<<CDFLAG_SIZE) | kStrict | kDRAM)                                  // 
