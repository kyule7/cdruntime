...
#define CD_MAP_3_1_0  ((8<<CDFLAG_SIZE) | kRelaxed | kDRAM | ERROR_VEC_0) //             # O{xdd,ydd,zdd}, I{fx,fy,fz}
...
#define CD_MAP_2_1_0  ((8<<CDFLAG_SIZE) | kRelaxed | kDRAM | ERROR_VEC_1) //# O{vnew,delv,arealg,vdov,dxx,...},I{deltaT,volo,v,x,y,z,xd,dxx,.} 
#define SWITCH_3_5_0  0                                                   //           CalcLagrangeElements
#define CD_MAP_3_5_0  ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_0) //# O{vnew,delv,arealg,vdov,dxx,...},I{deltaT,volo,v,x,y,z,xd,dxx,.}
...
#define CD_MAP_3_6_0  ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_0) //             # O{delx_zeta,delv_xi,delx_eta,delv_eta}, I{vnew}
//                    *************************************************** CommRecvMONOQ ************************************************* 
...
#define CD_MAP_2_2_0  ((8<<CDFLAG_SIZE) | kRelaxed | kDRAM | ERROR_VEC_1) // # O{dtcourant,dthydro}, I{regElemSize,regElemlist,qqc,ss,vdov,arealg,dvovmax}
