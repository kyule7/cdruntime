...
#define CD_MAP_2_0_0   ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_1)                  //   
#define SWITCH_3_0_0   0                                                   //           CalcForceForNodes (commRecv before)
#define CD_MAP_3_0_0   ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_0)                                                   //       
#define SWITCH_4_0_0   0                                                   //               CalcVolumeForceForElems (CommRecv before,   CommSBN after)
...
#define CD_MAP_7_1_0   ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_0)                                                   //                 
...
#define SWITCH_3_4_0   0                                                   //           CalcPositionForNodes (CommSyncPosVel is following)
#define CD_MAP_3_4_0   ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_0)                                                   //     
#define SWITCH_2_1_0   3                                                   //       LagrangeElements
...
#define CD_MAP_3_6_0   ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_0)                                                   //      
#define SWITCH_4_3_0   0                                                   //               CalcMonotonicQGradientsForElems
#define CD_MAP_4_3_0   ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_0)                                                   //              
...
#define CD_MAP_3_8_0   ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_0)                                                   //      
#define SWITCH_2_2_0   3                                                   //       CalcTimeConstraintsForElems (CommSyncPosVel is following)
#define CD_MAP_2_2_0   ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_1)                                                   //     
...
#define CD_MAP_3_10_0  ((8<<CDFLAG_SIZE) | kStrict  | kDRAM | ERROR_VEC_0)                                                   // 
