...
char *timerName[numberOfTimers] = {
    ...
    "    ljForce", "    eamHalo",    "commHalo",     "commReduce"};
...
void printPerformanceResults(int nGlobalAtoms, int printRate) {
  ...
  fprintf(screenOut, "        Timer        Rank: Min(s)       Rank: Max(s)     "
                     " Avg(s)    Stdev(s)\n");
  fprintf(screenOut, "_________________________________________________________"
