...
unsigned int preserveHaloForce(cd_handle_t *chd, int doeam,
...
//   void (*destroy)(struct BasePotentialSt** pot); //!< destruction of the
//   potential
//} BasePotential;
...
//   void (*unloadBuffer)(void* parms, void* data, int face, int bufSize, char*
//   buf);
