                            ...
                            )
{
    ...
    // Preserve array for gids of atoms
      ...
      cd_preserve(cdh, &(atoms->gid), sizeof(int*), kCopy,
...
#ifdef DO_PRV
      cd_preserve(cdh, &(atoms->r), sizeof(real3*), kCopy, 
          tmp_atoms_r_ptr, tmp_atoms_r_ptr);
      cd_preserve(cdh, atoms->r, r_size, kCopy, 
    ...
    // Preserve array for atoms->p
      ...
      assert(is_all != 1);
#ifdef DO_PRV
      cd_preserve(cdh, &(atoms->p), sizeof(real3*), kCopy, 
          "Atoms_p_ptr", "Atoms_p_ptr");
      cd_preserve(cdh, atoms->p, p_size, kCopy, 
          "Atoms_p", "Atoms_p");
#endif
      size += p_size;
    }
...
#ifdef DO_PRV
      cd_preserve(cdh, &(atoms->f), sizeof(real3*), kCopy, 
          "Atoms_f_ptr", "Atoms_f_ptr");
      cd_preserve(cdh, atoms->f, f_size, kCopy, 
          "Atoms_f", "Atoms_f");
#endif
      size += f_size;
    }
    ...
    // Preserve array for atoms->U
      ...
      assert(is_all != 1);
#ifdef DO_PRV
      cd_preserve(cdh, &(atoms->U), sizeof(real3*), kCopy, 
          "Atoms_u_ptr", "Atoms_u_ptr");
      cd_preserve(cdh, atoms->U, U_size, kCopy, 
          "Atoms_u", "Atoms_u");
#endif
      size += U_size;
    }
